				...
				<div class="card soft">
					...
					echo array_reduce($cart, function($r,$o){
						...
						return $r."<div class = 'display-flex'>
							<div class='display-stretch'>$o->name</div>
							<div class='display-none'>&dollar;$totalfixed</div>
						</div>";
					})?>
					</div>
					<?= cartTotals();?>
				...
				<div class="card soft">
					...
					<form class = "form">
						...
						<div class="form-control">
							<div class ="grid gap">
								<div class = "col-xc-12 col-md-6">
									<label for="payment-expiration" class="form-label">Exiration</label>
